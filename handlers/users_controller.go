...
func (c *UsersController) Get(id string) *response.ResponseEntity {
...
func (c *UsersController) Post(id string, req CreateUserRequest) *response.ResponseEntity {
...
func (c *UsersController) Put(id string, req UpdateUserRequest) *response.ResponseEntity {
	user, exists := fakeDB[id]
...
func (c *UsersController) Delete(id string) *response.ResponseEntity {
